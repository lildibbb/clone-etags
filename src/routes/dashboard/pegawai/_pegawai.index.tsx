				...
				<div className="flex flex-col gap-6">
					...
					<Card className="relative overflow-hidden">
						<div className="bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 p-6 text-white">
							...
							<h2 className="text-3xl font-bold mb-2">Pegawai Khairi</h2>
					...
					<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
						{[
							...
							{ id: "new", icon: MessageSquare, label: "Baru", count: 3 },
							...
							{ id: "completed", icon: Archive, label: "Selesai", count: 2 },
						...
						<Card className="p-6">
							<div className="flex flex-col items-center gap-4">
								...
								<div className="text-center">
									<h3 className="text-xl font-semibold">Khairi</h3>
								</div>
								<div className="w-full pt-4 border-t">
									...
									<p className="text-sm mt-2">
										Sila periksa aduan yang baru dan siasatan yang sedang
										berjalan
									</p>
								</div>
							</div>
